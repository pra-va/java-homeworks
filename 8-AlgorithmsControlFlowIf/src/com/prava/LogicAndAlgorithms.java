...
/**
 * This program demonstrates: 1) if and if-else; 2) for, while and do-while; 3)
 * uses break, continue and return (control flow statements); 4) uses
 * labeled-break and labeled-continue; 5) uses return to give back value; 6) has
 * few logical methods; 7) reads user input from console and detects data type;
...
public class LogicAndAlgorithms {
	...
	/**
	 * 1. Demonstrates if and if-else statements. Method will check if parameter is
	 * higher, lesser or equal to 100.
	 *
	...
	/**
	 * 4. Uses labeled-return and labeled-continue. Inside a method there is a
	 * infinite loop that uses labeled control flow statements to control the loop
	 * which should create date[][] double array that displays year month (from 1999
	 * to 2001).
	 */
	...
	/**
	 * 5) Uses return to give back value; 6) has few logical methods; 7) reads user
	 * input from console; 8) demonstrates switch statement. This is the main
	 * controller method which calls other methods to fulfil its main purport.
	 */
	...
	/**
	 * 7. Detects data type. This method is designed to showcase the data type
	 * detection using scanner class.
	 */
