...
/**
 * Programa, demonstruojanti Java kalbos kintamųjų sintaksę.
 * 
 * @author pra-va
 *
 */
...
public class Sintakse {
	...
	public static void main(String[] args) {
		...
		/**
		 * 4. Panaudoti objekto skaitinius ir vietinius kintamuosius.
		 */
		...
		System.out.println("\nDviračiai");
		System.out
				.println(canondale.getModelis() + " " + canondale.getPagaminta() + " " + canondale.getPavaruSkaicius());
		...
		/**
		 * 6. Pademonstruoti įvairių tipų (ne tik matematinių) operatorių eiliškumo
		 * tvarką.
		 */
		...
		/**
		 * 7. Pademonstruoti, kaip kelių tipų kintamieji gali būti panaudoti viename
		 * reiškinyje.
		 *
		 */
